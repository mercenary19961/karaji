...
> **📍 Doc sync:** CLAUDE.md last synced to commit `879b7c2` — 2026-07-06 09:36 (Mon). Convention: whenever you edit this file, refresh this line to the current commit — run `git log -1 --format="%h %cd" --date=format:"%Y-%m-%d %H:%M (%a)"` and paste the hash + date + time.
