...
> **📍 Doc sync:** CLAUDE.md last synced to commit `fa11dcd` — 2026-07-05 16:26 (Sun). Convention: whenever you edit this file, refresh this line to the current commit — run `git log -1 --format="%h %cd" --date=format:"%Y-%m-%d %H:%M (%a)"` and paste the hash + date + time.
