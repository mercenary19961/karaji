...
const dict = {
    ...
    'nav.clients': { ar: 'الزبائن', en: 'Clients' },
    ...
    'dash.recent': { ar: 'آخر الزيارات', en: 'Latest visits' },
    'dash.no_recent': { ar: 'لسا ما في زيارات', en: 'No visits yet' },
    'dash.all_clients': { ar: 'كل الزبائن', en: 'All clients' },
    ...
    'car.edit': { ar: 'تعديل المعلومات', en: 'Edit details' },
    ...
    'clients.title': { ar: 'الزبائن', en: 'Clients' },
    'clients.count': { ar: '{count} زبون', en: '{count} clients' },
    'clients.empty': { ar: 'لسا ما في زبائن مسجلين', en: 'No clients registered yet' },
    'client_edit.title': { ar: 'تعديل معلومات الزبون', en: 'Edit client details' },
    'client_edit.name': { ar: 'الاسم', en: 'Name' },
    'client_edit.phone': { ar: 'التلفون', en: 'Phone' },
    'client_edit.plate': { ar: 'رقم اللوحة', en: 'Plate number' },
    'client_edit.car': { ar: 'نوع السيارة', en: 'Car' },
    'client_edit.license': { ar: 'شهر الترخيص', en: 'License month' },
    'client_edit.no_license': { ar: 'بدون', en: 'None' },
    'client_edit.save': { ar: 'حفظ التعديلات', en: 'Save changes' },
