        ...
        <ShopLayout shop={shop}>
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_1.3fr] md:items-start md:gap-6">
                ...
                <div className="flex flex-col gap-3">
                    <h2 className="text-lg font-extrabold">سجل الزيارات</h2>
                    <div className="flex flex-col">
                        ...
                        {car.visits.length === 0 && (
                            <div className="bg-card text-muted-foreground rounded-2xl p-5 text-center text-base">لسا ما في زيارات لهالسيارة</div>
                        )}
                    </div>
                </div>
            </div>
